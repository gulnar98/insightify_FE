...
export default function Alert(props) {
    ...
    return (
    <div style={{ backgroundColor: color, borderRadius, color: textColor, border, padding, margin,  display: 'flex', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
