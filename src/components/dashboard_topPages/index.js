  ...
  return (
   ...
   <>
     <div className={styles.wrapper}>
       ...
       <Drop_down options={dropdownOptions} onChange={handleDropdownChange} border="1px solid #D6D6D6" textColor="#303742" borderRadius="6px" padding="7px 15px" fontFamily="Inter" fontWeight="500" fontSize="14px"  />
